...
class ClasseHerosSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $classes = [
            ...
            ['nom' => 'elfe',     'race' => 'elfe',     'pv_body' => 6, 'pv_mind' => 4, 'attr_body' => 2, 'attr_mind' => 3, 'des_attaque' => 1, 'des_defense' => 2, 'deplacement_base' => 5, 'bonus_sac' => 0, 'tags_equipement' => ['arme_legere', 'arme_courante', 'arme_distance', 'arme_arc_long', 'armure_legere', 'bouclier', 'potion_elfe', 'talisman_elfe', 'bottes_elfe']],
