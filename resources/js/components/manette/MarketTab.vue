...
// Deux modes : `live` (EtatMarche mappé, doc 04 §5 — saisie individuelle
// sur le téléphone : panier d'achats/ventes personnel, total projeté du
...
const props = defineProps({
    ...
    /**
     * Mode connecté — null en démo. Forme (mappée dans ManetteView) :
...
const emit = defineEmits(['toggle', 'qty', 'vendre', 'confirmer']);
