    ...
    'artefacts' => [
        ...
        'cartes' => [
            ...
            ['carte' => 'Rabbit Boots', 'nom' => 'Bottes de Lièvre',
                ...
                'manque' => "Deux écarts, tous deux sur un chemin PARTAGÉ. (1) Notre franchissement exige une FOSSE ; la carte dit « one discovered trap », et l'élargir change la règle pour tous les héros, pas seulement le porteur des bottes. (2) Le jet est un JetCompetence de Body à difficulté, quand la carte demande 1 dé de combat où seul le bouclier noir échoue. La cadence « une fois par tour », elle, est disponible depuis le 2026-09-03 (`frequence: une_fois_par_tour`)."],
